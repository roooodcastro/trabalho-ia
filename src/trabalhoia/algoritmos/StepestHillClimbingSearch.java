...
//                return SearchUtils.actionsFromNodes(current.getPathFromRoot());
    ...
    public double getLocalMin() {
        try {
            System.out.println("Iniciando busca de um mínimo local utilizando o método de subida de encosta mais íngrime");
    ...
    public double getLocalMax() {
        try {
            System.out.println("Iniciando busca de um máximo local utilizando o método de subida de encosta mais íngreme");
